...
function SimulationPage() {
  ...
  return <main className="container">
    ...
    {loading && <section className="panel simulation-status simulation-status--loading" role="status"><strong>AI 포커스 그룹을 구성하고 있습니다.</strong><p>제품 분석 → 페르소나 생성 → 소비자 반응 → Moderator 리포트 → 그룹 토론 순서로 처리됩니다.</p><div className="loading-bar"><span /></div></section>}
